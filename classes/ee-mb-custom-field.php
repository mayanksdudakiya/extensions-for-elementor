...
abstract class EE_MB_Custom_Field{
	...
	public function render_date( $field ){
		...
		<tr>
			...
			<td>
				<input class="es_date_picker" type="text" name="<?php echo $name; ?>" id="<?php echo $name; ?>" value="<?php echo $default; ?>" placeholder="<?php echo $placeholder; ?>" />	
				<?php if( $desc != '' ) {
					echo '<p class="description">' . $desc . '</p>';
				}?>
			</td>
	...
	public function render_time( $field ){
		...
		<tr>
			...
			<td>
				<input class="es_time_picker" type="text" name="<?php echo $name; ?>" id="<?php echo $name; ?>" value="<?php echo $default; ?>" placeholder="<?php echo $placeholder; ?>" />	
				<?php if( $desc != '' ) {
					echo '<p class="description">' . $desc . '</p>';
				}?>
			</td>
	...
	public function render_textarea( $field ){
		...
		<tr>
			...
			<td>
				<textarea name="<?php echo $name; ?>" id="<?php echo $name; ?>" placeholder="<?php echo $placeholder; ?>" cols="50" rows="3"><?php echo $default; ?></textarea>	
				<?php if( $desc != '' ) {
					echo '<p class="description">' . $desc . '</p>';
				}?>
			</td>
